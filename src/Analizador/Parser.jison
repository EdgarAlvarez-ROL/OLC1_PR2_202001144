...
ASIGNACION  :   id '=' EXP 
            {
                $$ = new Asignacion($1, $3, "0", undefined, @1.first_line, @1.first_column);
            }
            |   id '[' EXP ']' '=' EXP  
            {
                $$ = new Asignacion($1, $6, "1", $3, @1.first_line, @1.first_column);
            }
            |   id '++' 
            {
                ...
                $$ = new Asignacion($1, incdec, "0", undefined, @1.first_line, @1.first_column);
            }
            |   id '--' 
            {
                ...
                $$ = new Asignacion($1, incdec22, "0", undefined, @1.first_line, @1.first_column);
            }
